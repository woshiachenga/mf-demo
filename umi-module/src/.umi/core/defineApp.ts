...
import type { IRuntimeConfig as Plugin0 } from '../plugin-initialState/runtimeConfig.d'
import type { IRuntimeConfig as Plugin1 } from '../plugin-layout/runtimeConfig.d'
